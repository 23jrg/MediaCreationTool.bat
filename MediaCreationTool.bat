...
:Universal MCT wrapper script for all Windows 10/11 versions from 19H2 to 25H2!
...
:: on upgrade: latest build, on offline install: 11 25h2 26200.5074 / 11 24H2 26100.4349 / 11 23H2 22631.2861 / 11 22H2 22621.1702 / 11 21H2 22000.318 / 22H2 19045.3803 / 21H2 19044.1288 / 21H1 19043.1348 / 20H2 19042.1052

::# uncomment to skip GUI dialog for MCT choice: 19H2 to 11 25H2 - or rename script: "11_25H2 MediaCreationTool.bat"
rem set MCT=2507
...
set VERSIONS=1909,20H1,20H2,21H1,21H2,22H2,11_21H2,11_22H2,11_23H2,11_24H2,11_25H2
set /a dV=17
...
for %%V in (9.19H2 10.2004 10.20H1 11.2009 11.20H2 12.2104
 12.21H1 13.2109 13.21H2 14.2210 14.22H2 15.2110 15.11_21H2 16.2209 16.11_22H2 17.2310 17.11_23H2 18.2409 18.11_24H2 19.2507 19.11_25H2) do for %%s in (%MCT% %~n0 %*) do if /i %%~xV equ .%%~s set "MCT=%%~nV" & set "VID=%%~s"
